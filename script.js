...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function initializeCookieBanner() {
        ...
        console.log('Accept cookies button:', acceptCookies); // Debug
        console.log('Manage cookies button:', manageCookies); // Debug
        ...
        console.log('Cookies already accepted?', cookiesAccepted); // Debug
        
        if (!cookiesAccepted) {
            // Mostrar el banner después de un delay
            setTimeout(() => {
                console.log('Showing cookie banner'); // Debug
                cookieBanner.style.display = 'block';
                // Ajustar el padding-bottom del body para evitar que el contenido quede detrás
        ...
        acceptCookies.addEventListener('click', () => {
            console.log('Accept cookies clicked'); // Debug
        ...
        if (manageCookies) {
            manageCookies.addEventListener('click', (e) => {
                e.preventDefault();
                console.log('Manage cookies clicked'); // Debug
